...
In this first model, we include all available features including the dummy NA indicators. Features include:
...
nb4 <- glm.nb(TARGET~ VolatileAcidity + TotalSulfurDioxide + Alcohol +
                as.factor(LabelAppeal) +
                as.factor(AcidIndex) + 
                as.factor(STARS),
              data=clean_df)
