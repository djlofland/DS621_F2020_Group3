...
This table summarizes the **RMSE**, **$R^2$**, **MAE**, **AIC** and **BIC** for all 6 models.  In terms of raw metrics, The Linear regressions (**lm5** and **lm6**) had the overall best performance based on **RMSE** and **$R62$**; however, **Poisson Model 1** had the best performance based on **AIC** and **BIC**.  

Overall, **RMSE** an **$R^2$** were not significantly different across the 6 models, given this we chosoe **Poisson Model 1** since it had a far lower **AIC**.
