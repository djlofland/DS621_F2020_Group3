...
The following table discusses each of the model performance metrics on the training dataset. These values indicate there is a minor improvement in model performance after applying transformations and selecting for significant parameters.  The F-statistic however grows as we applied changes to the models and the increase in F-values suggest greater overall model statistical significance.
```{r}
