...
The distribution profiles sure the prevalance of kurtosis, specifically right skewness in variables BASERUN_CS, BASERUN_CB, FIELDING_E, PITCHING_RB, PITCHING_H and PITCHING_SO. Furthermore BATTING_HBP, BATTING_HR, PITCHING_HR and BATTING_SO appear bimodal. These deviations from a traditional normal distribution can be problematic for linear regression assumptions, and thus we might need to transform the data.
