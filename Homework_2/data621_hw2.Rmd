---
title: 'DS 621: Homework 2 (Group3)'
subtitle: 'Homework 2 Description'
...
output:
  html_document:
    theme: cerulean
    highlight: pygments
    css: https://raw.githubusercontent.com/djlofland/DS621_F2020_Group3/master/Homework_2/lab.css
    toc: true
    toc_float: true
  pdf_document:
...
```{r, echo=TRUE}
df <- read.csv ("https://raw.githubusercontent.com/djlofland/DS621_F2020_Group3/master/Homework_2/datasets/classification-output-data.csv", header=TRUE)
```
...
Here is the raw confustion matrix with rows reflecting Actual and columns are Predicted. 
...
roc_plot <- function(df, probability) {
  ...
  plot = ggplot + geom_line() + geom_abline(intercept = 0) + 
...
classification_data <- t(data.frame(Accuracy, Error, Precision, Sensitivity, Specificity, F1_score,
AUC))
classification_data
```
